...
var book = new book_1.Book(ENV);
describe("Test Suite for books: ", function () {
    it("Check Existence of index function", function () {
    ...
    it("Index Returns An Array of Books", function () { return __awaiter(void 0, void 0, void 0, function () {
        var results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, book.index().then(function (item) {
    ...
    it('create method should add a book', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, book.create({
    ...
    it('show method should return the correct book', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, book.show("1")];
                case 1:
                    result = _a.sent();
                    expect(result.length).toBeGreaterThanOrEqual(0);
                    return [2 /*return*/];
